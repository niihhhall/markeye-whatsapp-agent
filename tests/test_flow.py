...
BASE_URL = "https://markeye-agent-production.up.railway.app" 
...
async def main():
    print("Mark Test Suite starting...")
    
    # 1. Test a simple text message
    await test_text_message("How can Markeye help me with my business?")
    ...
    print("\nTest finished. Now check your terminal/Railway logs for Mark's thinking process!")
